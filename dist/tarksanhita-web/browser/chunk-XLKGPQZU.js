...
// src/app/pages/shared-pages/static-page.ts
var _forTrack0 = ($index, $item) => $item.heading;
function StaticPage_Conditional_0_For_4_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function StaticPage_Conditional_0_For_4_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(bullet_r2);
  }
}
function StaticPage_Conditional_0_For_4_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 7);
    \u0275\u0275repeaterCreate(1, StaticPage_Conditional_0_For_4_Conditional_7_For_2_Template, 3, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const section_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(section_r3.bullets);
  }
}
function StaticPage_Conditional_0_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 3)(1, "div", 5)(2, "h2");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 6);
    \u0275\u0275repeaterCreate(5, StaticPage_Conditional_0_For_4_For_6_Template, 2, 1, "p", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275conditionalCreate(7, StaticPage_Conditional_0_For_4_Conditional_7_Template, 3, 0, "ul", 7);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const section_r3 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(section_r3.heading);
    \u0275\u0275advance(2);
    \u0275\u0275repeater(section_r3.paragraphs);
    \u0275\u0275advance(2);
    \u0275\u0275conditional((section_r3.bullets == null ? null : section_r3.bullets.length) ? 7 : -1);
  }
}
function StaticPage_Conditional_0_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "a", 9);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", page_r4.cta.link);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(page_r4.cta.label);
  }
}
function StaticPage_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ts-page-banner", 0);
    \u0275\u0275elementStart(1, "main", 1)(2, "div", 2);
    \u0275\u0275repeaterCreate(3, StaticPage_Conditional_0_For_4_Template, 8, 2, "section", 3, _forTrack0);
    \u0275\u0275conditionalCreate(5, StaticPage_Conditional_0_Conditional_5_Template, 3, 2, "div", 4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const page_r4 = ctx;
    \u0275\u0275property("heading", page_r4.title)("lede", page_r4.lede);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(page_r4.sections);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(page_r4.cta ? 5 : -1);
  }
}
var PAGES = {
  alumni: {
...
var StaticPage = class _StaticPage {
  ...
  static \u0275fac = function StaticPage_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StaticPage)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StaticPage, selectors: [["ts-static-page"]], decls: 1, vars: 1, consts: [[3, "heading", "lede"], [1, "section"], [1, "container", 2, "max-width", "920px"], [1, "panel"], [1, "text-center"], [1, "panel-head"], [1, "panel-body", "prose"], [1, "link-list", 2, "margin-top", "8px"], [2, "padding", "8px 0", "display", "block", "font-size", ".86rem"], [1, "btn", "btn-gold", 3, "routerLink"]], template: function StaticPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, StaticPage_Conditional_0_Template, 6, 3);
    }
    if (rf & 2) {
      let tmp_0_0;
      \u0275\u0275conditional((tmp_0_0 = ctx.content()) ? 0 : -1, tmp_0_0);
    }
  }, dependencies: [RouterLink, PageBanner], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StaticPage, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StaticPage, { className: "StaticPage", filePath: "src/app/pages/shared-pages/static-page.ts", lineNumber: 154 });
})();
export {
  StaticPage
};
//# sourceMappingURL=chunk-XLKGPQZU.js.map
