...
export const routes: Routes = [
  ...
  // ============================================================
  {
    path: '',
    loadComponent: () =>
      import('./layout/public-layout').then(m => m.PublicLayout),
    ...
    children: [
      ...
      // Home
      {
        ...
        title:
          'Tarksanhita Debate Forum — Express, Challenge, Persuade, Enlighten'
      },
...

      {
        path: 'debates/start',
        loadComponent: () =>
          import('./pages/debates/start-debate')
            .then(m => m.StartDebatePage),
...

      {
        path: 'debates/:slug',
        loadComponent: () =>
          import('./pages/debates/debate-detail')
            .then(m => m.DebateDetailPage),
...

      {
        path: 'publications',
        loadComponent: () =>
          import('./pages/shared-pages/content-list')
            .then(m => m.ContentListPage),
        ...
        data: {
          ...
          title: 'Publications',
          lede:
            'Journals, monographs and occasional papers published by the Centre.'
        },
...

      {
        ...
        data: {
          ...
          title: 'Case Studies',
          lede:
            'Structured notes on landmark judgments, with argument maps and analysis of dissents.'
        },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          title: 'Legal Topics',
          lede:
            'Subject clusters across constitutional, criminal, civil, corporate, technology and human rights law.'
        },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          title: 'Events',
          lede:
            'Conferences, seminars, guest lectures, competitions and observances.'
        },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          title: 'Notice Board',
          lede:
            'Official notifications, circulars and announcements issued by the Centre.'
        },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          title: 'Latest News',
          lede:
            'News and announcements from across the Centre.'
        },

        title: 'Latest News — Tarksanhita'
      },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          lede:
            'Short-form commentary on legislation, judgments and legal method.'
        },
      ...
      // ==========================================================
      {
        ...
        data: {
          ...
          lede:
            'Academic staff, fellows and members of the governing council.'
        },
      ...
      // Alumni
      {
        path: 'alumni',
        loadComponent: () =>
          import('./pages/shared-pages/static-page')
            .then(m => m.StaticPage),
      ...
      // Forbidden
      {
        path: 'forbidden',
        loadComponent: () =>
          import('./pages/shared-pages/message-page')
            .then(m => m.MessagePage),

        data: {
          code: '403',
          heading: 'Access Denied',
          body:
            'Your account does not carry the role required for this section.'
        }
      },
...

  {
    ...
    loadComponent: () =>
      import('./pages/admin/admin-layout')
    ...
    children: [
...

      {
        ...
        loadComponent: () =>
          import('./pages/admin/participation-report')
            .then(m => m.AdminParticipationReport),
...

      {
        ...
        loadComponent: () =>
          import('./pages/admin/content-form')
            .then(m => m.AdminContentForm)
      },
...

      {
        ...
        loadComponent: () =>
          import('./pages/admin/content-list')
            .then(m => m.AdminContentList)
      }
    ]
  },
